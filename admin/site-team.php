...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_settings') {
        foreach (['team_meta_title','team_meta_title_desc','team_hero_heading','team_hero_body','team_section_heading'] as $f) {
...
<div class="form-grid">
  ...
  <div class="form-group full-width"><label>Hero Subtext</label><textarea name="team_hero_body" rows="2"><?= h(setting('team_hero_body','Sample text. Lorem ipsum dolor sit amet, consectetur adipiscing elit nullam nunc justo sagittis suscipit ultrices.&nbsp;Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.')) ?></textarea></div>
...
<?php $_sections_page = 'team'; require '_sections_editor.php'; ?>
