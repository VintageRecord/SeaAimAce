...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-value stat-accent"><?= $features_count ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Spaces</div>
        <div class="stat-value stat-accent"><?= $spaces_count ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Pricing Plans</div>
        <div class="stat-value stat-accent"><?= $plans_count ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Amenities</div>
        <div class="stat-value stat-accent"><?= $amenities_count ?></div>
    </div>
    <div class="stat-card">
    ...
    <div class="stat-card">
        ...
        <div class="stat-value stat-accent"><?= $new_submissions ?></div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body" style="padding:0">
        <div class="table-wrapper">
            <table>
                <thead>
                    <tr><th>Name</th><th>Email</th><th>Interest</th><th>Date</th></tr>
                </thead>
                <tbody>
...
<?php else: ?>
<div class="alert alert-info">No contact submissions yet. They'll appear here once visitors fill out the form.</div>
<?php endif; ?>

<div class="card">
    <div class="card-header"><h2>Quick Links</h2></div>
    <div class="card-body" style="display:flex;gap:10px;flex-wrap:wrap">
        <a href="general.php"   class="btn btn-secondary">⚙️ General & Hero</a>
