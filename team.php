...
$db = get_db();
$current_page = 'team';
$team_members = $db->query('SELECT * FROM team_members ORDER BY sort_order ASC')->fetchAll();
?>
<!DOCTYPE html>
      ...
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <div class="u-expanded-width u-list u-list-1">
          ...
          <?php foreach ($team_members as $m): ?>
            <div class="u-align-left u-container-align-left u-container-style u-image u-list-item u-repeater-item u-shading u-shape-rectangle" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="250" style="background-image:linear-gradient(0deg,rgba(0,0,0,.4),rgba(0,0,0,.4)),url('<?= h($m['image']) ?>')">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                <h3 class="u-custom-font u-font-montserrat u-text u-text-body-alt-color u-text-3"><?= h($m['name']) ?></h3>
                <p class="u-text u-text-body-alt-color u-text-4"><?= h($m['bio']) ?></p>
